...
const char *WINDOWTITLE = { "Project 3 - texture mapping" };
...
InitMenus( )
{
    ...
    int distortionmenu = glutCreateMenu( DistortionMenu );
    glutAddMenuEntry( "Off",  0 );
    glutAddMenuEntry( "On",   1 );
...
InitGraphics( )
{
    ...
    unsigned char * TextureArray0 = BmpToTexture( (char*)"/Users/xiaoranLiu/Desktop/worldtex.bmp", &width0, &height0 );
