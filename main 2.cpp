...
//  project2
//
//  Created by Xiaoran Liu on 10/7/21.
//
...
const char *WINDOWTITLE = { "OpenGL / Animate a Helicpoter!" };
...
Display( )
{
    ...
    if(WhichPerspective == INSIDE){
        gluLookAt( -0.4, 1.8, -4.9,     0., 0.,-15.0,     0., 1., 0. );
    }
    else
    ...
    glLoadIdentity( );
    glColor3f( 1., 1., 1. );
    DoRasterString( 5., 5., 0., (char *)"Project2 - Xiaoran Liu" );
